...
<?php endif; ?>
		...
		<form class="woocommerce-form woocommerce-form-login login" method="post" novalidate>
			...
			<p class="form-row gstore-rememberme-row">
			...
			<p class="form-row gstore-login-buttons">
				<?php wp_nonce_field( 'woocommerce-login', 'woocommerce-login-nonce' ); ?>
				<button type="submit" class="woocommerce-button button woocommerce-form-login__submit<?php echo esc_attr( wc_wp_theme_get_element_class_name( 'button' ) ? ' ' . wc_wp_theme_get_element_class_name( 'button' ) : '' ); ?>" name="login" value="<?php esc_attr_e( 'Log in', 'woocommerce' ); ?>"><?php esc_html_e( 'Acessar', 'gstore' ); ?></button>
				<a href="#customer_login" class="woocommerce-button button button--outline gstore-btn-register"><?php esc_html_e( 'Cadastrar-se', 'gstore' ); ?></a>
			</p>
...
<?php if ( 'yes' === get_option( 'woocommerce_enable_myaccount_registration' ) ) : ?>
	...
	<div class="u-column2 col-2">
		...
		<form method="post" class="woocommerce-form woocommerce-form-register register" <?php do_action( 'woocommerce_register_form_tag' ); ?> >
			...
			<?php 
			// Remove o hook padrão do texto de privacidade
			remove_action( 'woocommerce_register_form', 'wc_registration_privacy_policy_text', 20 );
			do_action( 'woocommerce_register_form' ); 
			?>

			<p class="woocommerce-form-row form-row gstore-register-submit-wrapper">
				<?php wp_nonce_field( 'woocommerce-register', 'woocommerce-register-nonce' ); ?>
				<button type="submit" class="woocommerce-Button woocommerce-button button<?php echo esc_attr( wc_wp_theme_get_element_class_name( 'button' ) ? ' ' . wc_wp_theme_get_element_class_name( 'button' ) : '' ); ?> woocommerce-form-register__submit" name="register" value="<?php esc_attr_e( 'Register', 'woocommerce' ); ?>"><?php esc_html_e( 'Register', 'woocommerce' ); ?></button>
				<button type="button" class="gstore-register-info-btn" aria-label="<?php esc_attr_e( 'Informações sobre cadastro', 'gstore' ); ?>" data-modal="gstore-register-info-modal">
...
<div id="gstore-register-info-modal" class="gstore-modal" role="dialog" aria-labelledby="gstore-modal-title" aria-hidden="true">
