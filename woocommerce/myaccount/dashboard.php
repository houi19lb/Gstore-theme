	...
	<div class="gstore-account-dashboard-grid">
		<div class="gstore-account-primary">
			...
			<dl class="gstore-account-stats">
				...
				<div class="gstore-account-card gstore-account-stat--<?php echo esc_attr( $key ); ?>"><dt><?php echo esc_html( $label ); ?></dt><dd><?php echo esc_html( $counts[ $key ] ); ?></dd></div>
				<?php endforeach; ?>
			</dl>
			<div class="gstore-account-shortcuts">
				<?php if ( function_exists( 'gstore_cashback_account_is_visible' ) && gstore_cashback_account_is_visible() ) : ?>
				<a class="gstore-account-card gstore-account-shortcut" href="<?php echo esc_url( wc_get_account_endpoint_url( 'minhas-moedas' ) ); ?>"><span class="gstore-account-icon" aria-hidden="true"><i class="fa-solid fa-coins"></i></span><span><strong><?php esc_html_e( 'Minhas moedas', 'gstore' ); ?></strong><small><?php esc_html_e( 'Veja seu saldo e suas movimentações', 'gstore' ); ?></small></span><svg class="account-arrow lucide lucide-arrow-right" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false"><path d="M5 12h14"/><path d="m12 5 7 7-7 7"/></svg></a>
				<?php endif; ?>
