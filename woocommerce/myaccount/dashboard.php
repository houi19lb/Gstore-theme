...
<div class="gstore-dashboard">
	...
	<div class="gstore-dashboard__section">
		...
		<div class="gstore-dashboard__actions">
			...
			<?php
			// Usa a página de catálogo ao invés da loja
			$catalogo_page = get_page_by_path( 'catalogo' );
			$catalogo_url = $catalogo_page ? get_permalink( $catalogo_page->ID ) : home_url( '/catalogo' );
			?>
			<a href="<?php echo esc_url( $catalogo_url ); ?>" class="gstore-dashboard__action-card gstore-dashboard__action-card--highlight">
				<div class="gstore-dashboard__action-icon">
				...
				<div class="gstore-dashboard__action-content">
					...
					<span class="gstore-dashboard__action-desc"><?php esc_html_e( 'Explore nosso catálogo', 'gstore' ); ?></span>
				</div>
				<span class="gstore-dashboard__action-arrow">
					<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="9 18 15 12 9 6"></polyline></svg>
				</span>
