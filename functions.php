...
function gstore_render_flash_sale_home_section() {
	...
	return sprintf(
		'<section class="gstore-flash-sale-section" aria-label="%1$s"><header class="gstore-flash-sale-heading"><div class="gstore-flash-sale-heading__intro"><h2><i class="fa-solid fa-bolt" aria-hidden="true"></i> %1$s</h2><p>Preços especiais por tempo limitado</p></div><div class="gstore-flash-sale-live"><i class="fa-solid fa-circle" aria-hidden="true"></i><span>%4$s</span></div><div class="gstore-flash-sale-clock"><i class="fa-regular fa-clock" aria-hidden="true"></i><span class="gstore-flash-sale-clock__label">Termina em</span><time data-gstore-flash-sale-end="%2$s">--:--:--</time><div class="gstore-flash-sale-clock__mobile-units" aria-live="polite"><div data-gstore-flash-sale-mobile-countdown="days"><strong>00</strong><span>Dias</span></div><div data-gstore-flash-sale-mobile-countdown="hours"><strong>00</strong><span>Horas</span></div><div data-gstore-flash-sale-mobile-countdown="minutes"><strong>00</strong><span>Min</span></div><div data-gstore-flash-sale-mobile-countdown="seconds"><strong>00</strong><span>Seg</span></div></div></div></header><div class="Gstore-products-grid">%3$s</div>%5$s</section>',
		esc_html__( 'Ofertas relâmpago', 'gstore' ),
