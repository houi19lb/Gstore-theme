...
function gstore_enqueue_styles() {
	...
	if (
		...
		if ( function_exists( 'is_account_page' ) && is_account_page() ) {
			wp_add_inline_style(
				'gstore-style',
				'body.woocommerce-account{--gstore-account-canvas:#f8f7f2;--gstore-account-sidebar:#e4e4dc;--gstore-account-divider:#c9c8be;background:var(--gstore-account-canvas)}body.woocommerce-account main.wp-block-group.is-layout-constrained,body.woocommerce-account main#wp--skip-link--target.wp-block-group.is-layout-constrained,body.woocommerce-account main.wp-block-group.wp-block-group-is-layout-constrained,body.woocommerce-account main#wp--skip-link--target.wp-block-group.wp-block-group-is-layout-constrained{width:100%;max-width:none;min-height:calc(100svh - var(--gstore-sticky-offset,110px));margin:0;padding:0;background:var(--gstore-account-canvas)}body.woocommerce-account .entry-content,body.woocommerce-account .wp-block-post-content,body.woocommerce-account .entry-content>.woocommerce,body.woocommerce-account .wp-block-post-content>.woocommerce{width:100%;max-width:none!important;margin:0!important}.gstore-myaccount{--gstore-account-sidebar-width:292px;--gstore-account-gutter:var(--gstore-container-padding-inline,20px);--gstore-account-edge:max(0px,calc((100% - var(--gstore-container-max-width,1280px))/2));--gstore-account-split:calc(var(--gstore-account-edge) + var(--gstore-account-gutter) + var(--gstore-account-sidebar-width));box-sizing:border-box;width:100%;max-width:none;min-height:calc(100svh - var(--gstore-sticky-offset,110px));margin:0;padding:0;background:var(--gstore-account-canvas)}.gstore-myaccount--authenticated{background:linear-gradient(to right,var(--gstore-account-sidebar) 0 var(--gstore-account-split),var(--gstore-account-canvas) var(--gstore-account-split) 100%)}.gstore-myaccount__layout{display:grid;grid-template-columns:var(--gstore-account-sidebar-width) minmax(0,1fr);gap:0;box-sizing:border-box;width:100%;max-width:var(--gstore-container-max-width,1280px);min-height:inherit;margin:0 auto;padding-inline:var(--gstore-account-gutter);align-items:stretch;background:transparent}.gstore-myaccount__sidebar{min-width:0;padding:clamp(28px,3vw,42px) 22px;border-right:1px solid var(--gstore-account-divider);background:var(--gstore-account-sidebar)}.gstore-myaccount__content,main.gstore-myaccount__content{min-width:0;padding:clamp(34px,4vw,54px) clamp(28px,4vw,54px) 64px!important;background:var(--gstore-account-canvas)!important}.gstore-myaccount-nav-toggle,.gstore-myaccount-nav-backdrop,.gstore-myaccount-nav__mobile-header{display:none}.gstore-myaccount-nav{min-width:0;overflow:hidden}.gstore-myaccount-nav__user{display:flex;align-items:center;gap:12px;padding:0 0 22px;border-bottom:1px solid var(--gstore-account-divider)}.gstore-myaccount-nav__avatar{flex-shrink:0}.gstore-myaccount-nav__avatar img{display:block;width:44px;height:44px;border-radius:50%;object-fit:cover}.gstore-myaccount-nav__user-info{display:flex;flex-direction:column;gap:2px;min-width:0}.gstore-myaccount-nav__user-name,.gstore-myaccount-nav__user-email{overflow:hidden;white-space:nowrap;text-overflow:ellipsis}.gstore-myaccount-nav__list{list-style:none;margin:0;padding:12px 0 0}.gstore-myaccount-nav__item{margin:0}.gstore-myaccount-nav__link{display:flex;align-items:center;min-height:44px;gap:12px;padding:11px 13px;border-radius:6px;color:#343a36;font-size:12px;line-height:18px;text-decoration:none}.gstore-myaccount-nav__item.is-active .gstore-myaccount-nav__link{background:#fff}.gstore-myaccount-nav__icon{display:flex;flex:0 0 20px;align-items:center;justify-content:center;width:20px;height:20px}.gstore-myaccount-nav__label{flex:1}.gstore-myaccount-nav__item:last-child .gstore-myaccount-nav__link{margin-top:8px;border-top:1px solid var(--gstore-account-divider)}@media(max-width:1024px){.gstore-myaccount{--gstore-account-sidebar-width:220px}}@media(max-width:768px){.gstore-myaccount{--gstore-account-gutter:0px;min-height:calc(100svh - var(--gstore-account-mobile-header-height,66px));background:var(--gstore-account-canvas)}.gstore-myaccount__layout{grid-template-columns:minmax(0,1fr)}.gstore-myaccount__sidebar{padding:18px 14px 0;border-right:0;background:transparent}.gstore-myaccount-nav-shell.is-enhanced .gstore-myaccount-nav-toggle{display:flex;align-items:center;justify-content:space-between;width:100%;min-height:64px;padding:12px 14px;border:1px solid var(--gstore-account-divider);border-radius:4px;background:var(--gstore-account-sidebar);color:#343a36;text-align:left}.gstore-myaccount-nav-toggle__copy{display:grid;gap:2px;min-width:0}.gstore-myaccount-nav-toggle__eyebrow{font-size:10px;line-height:13px;text-transform:uppercase}.gstore-myaccount-nav-toggle__current{overflow:hidden;font-size:14px;line-height:21px;text-overflow:ellipsis;white-space:nowrap}.gstore-myaccount-nav-toggle__icon{display:inline-flex;flex:0 0 38px;align-items:center;justify-content:center;width:38px;height:38px;border-radius:50%;background:#f4f7f3}.gstore-myaccount-nav-shell.is-enhanced .gstore-myaccount-nav{position:fixed;z-index:9999;top:0;bottom:0;left:0;width:min(88vw,340px);max-height:100dvh;transform:translateX(-104%);visibility:hidden}.gstore-myaccount-nav-shell.is-enhanced.is-open .gstore-myaccount-nav{transform:translateX(0);visibility:visible}.gstore-myaccount__content,main.gstore-myaccount__content{padding:30px 14px 46px!important}}'
			);
		}
