				...
				<?php else : ?>
					<form class="gstore-athlete-form" method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>" enctype="multipart/form-data">
						...
						<div class="gstore-athlete-form-grid">
							...
							<label class="gstore-athlete-form-grid__wide"><span><?php esc_html_e( 'Documento de identidade', 'gstore' ); ?></span><input required type="file" accept="application/pdf,image/*" name="gstore_athlete_identity_document"><small><?php esc_html_e( 'PDF ou imagem de até 8 MB. O arquivo é armazenado em área privada.', 'gstore' ); ?></small></label>
						</div>
