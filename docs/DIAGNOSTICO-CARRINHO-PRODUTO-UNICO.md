...
- A implementa��o n�o usa mais `empty_cart()` nem restaura��o de carrinho em requisi��o AJAX de parcelas.
...
- **`includes/blu/class-gstore-blu-checkout-handler.php`**
  - `ajax_product_installment_quotes()`:
    - n�o usa `empty_cart()` nem `add_to_cart()` para simula��o;
    - calcula base pelo pre�o do produto e quantidade;
